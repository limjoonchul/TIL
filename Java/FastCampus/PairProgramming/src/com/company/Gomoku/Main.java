 ...
 * 오목은 다음 기능을 포함한다.
 *
 * 0. 15x15 오목판을 이용한다. //gomoku 클래스에 생성
 *
 * 1. 두 명의 플레이어가 번갈아 돌을 놓을 수 있도록 한다. //플레이어 객체 두명 생성 gomoku에 생성
 *   1.0 돌의 위치는 키보드로 좌표를 입력 받는다.
 *   1.1 돌을 놓을 때 둘 수 없는 곳에 돌을 놓을 경우 다시 입력 받는다. //continue
 *   1.2 3-3은 반칙이므로 즉시 패배한다. //break 사용
 *
